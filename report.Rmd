...
client_analytical_record <- client_analytical_record %>%
  left_join(client %>% rename_with(~paste0("owner_", .)), by = c("owner_client_id" = "client_id"))
