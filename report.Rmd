...
sum(is.na(one_hot_loans))
print('einnahmen_1993-01' %in% names(one_hot_loans))
head(one_hot_loans$`einnahmen_1993-01`)

```


```{r}
# Plot für alle A# Splitting the data into training and test sets
...
confusionMatrix(predictions, test_set$is_good_loan)ccounts
```
