...
trans_per_month_new <- trans_per_month %>%
  pivot_wider(
    ...
    names_sort = TRUE,
    values_fill = list(einnahmen = 0, ausgaben = 0)
  ) 

trans_per_month_new <- trans_per_month_new %>%
  mutate(`kontostand_ende_monat_1993-01` = ifelse(is.na(`kontostand_ende_monat_1993-01`), 0, `kontostand_ende_monat_1993-01`))
